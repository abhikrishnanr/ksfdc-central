...
DROP TABLE IF EXISTS ticket_attendance;
DROP TABLE IF EXISTS ticket_checker_sessions;
DROP TABLE IF EXISTS ticket_checker_users;
...
DROP TABLE IF EXISTS public_email_otps;
